# -*- coding: utf-8 -*-
"""
Created on Fri Dec 25 17:19:07 2020
...
e = Entry(root, width =45, borderwidth = 2)
...
button_addition = Button(root, text="+", padx =44, pady=20, command= button_addition)
...
button_subtract = Button(root, text="-", padx =44, pady=20, command= button_subtract)
